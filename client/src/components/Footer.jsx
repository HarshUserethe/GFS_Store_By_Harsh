    ...
    <Box sx={{ bgcolor: "#efeef3 ", color: "#fff", p: 2 }}>
      ...
      >
        ...
        <Grid item xs={12} md={4}>
          ...
          <Typography sx={{ mt: 2, mb: 1, color: "#000", fontSize: ".8rem" }}>
            FOLLOW US ON:-
          </Typography>
          <Stack direction="row" spacing={2}>
            <a
              href="https://www.facebook.com/share/1GgUWUu4sY/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Facebook sx={{ color: "#000", cursor: "pointer" }} />
            </a>
            <a
              href="https://www.instagram.com/gosu_drow7eleven"
              target="_blank"
              rel="noopener noreferrer"
            >
              <AiFillInstagram color="#000" size={23} />
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <RiWhatsappFill color="#000" size={23} />
            </a>
            <a
              href="https://www.youtube.com/@DrowOfficial27"
              target="_blank"
              rel="noopener noreferrer"
            >
              <YouTube sx={{ color: "#000", cursor: "pointer" }} />
            </a>
          </Stack>
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          <Typography
            sx={{ mb: 1, color: "gray", fontSize: ".8rem", fontWeight: "400" }}
          >
